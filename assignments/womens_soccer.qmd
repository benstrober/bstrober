...
```
The P-Value is above 0.5 which means there is no statistical significance and the data is much higher at this point. For whole season 2023 the mean of x was .500 so about half a goal. After filtering the date it goes up to 1.125. 
