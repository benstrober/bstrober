...
Why do some teams not have data for a lot of the years, such as Appalachian State?
...
**Answer** Houston had a nearly 70% increase in attendance which is nuts. A lot of these schools also are not power football schools, which means they likely had a better year than the past, causing an uptick in attendance.
...
**Answer** I'm surprised that 4 teams score half or better of its shots on goal. I feel like that number would be low for most teams because shots from far out still count as on goal if they are from really far out. I think it would make sense to narrow the data based on those 4 teams. Efficency of JMU is a good story. They haven't taken many shots on goal, but have converted on prime opportunities. How does this translate to outcomes?
