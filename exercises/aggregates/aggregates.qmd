...
I notice there is a lot of data from players on multiple teams, as they were traded at some point during the season. I also notice Bam Adebayo played in 2598 minutes, which is much more than most the others.
...
Shooting guard shows up 162 times, 23 more than the second highest position which is centers. Point guards showed up much less at only 115.
...
The combination position groups which make up very small numbers, but slightly skew the data from standard position players. Also some of them are PG frst and SG second, vice versa.
